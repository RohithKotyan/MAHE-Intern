    ...
    <div className="pt-32 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 mb-24 text-center relative">
        ...
        <motion.div {...fadeUp}>
          ...
          <h1 className="text-4xl lg:text-6xl font-bold text-[var(--text-primary)] mb-6 leading-tight max-w-4xl mx-auto">
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeUp} className="relative group">
            ...
            <div className="relative z-10 rounded-3xl border border-eo-outline-variant/30 overflow-hidden bg-eo-surface-container-high h-[500px] flex items-center justify-center">
              <div className="text-center p-12">
                <span className="material-symbols-outlined text-primary-500 text-7xl mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>
                  agriculture
                </span>
                <p className="text-[var(--text-muted)] text-sm mt-4">Sustainable Agriculture AI</p>
              </div>
            </div>
            <div className="absolute -bottom-6 -right-6 glass-panel p-6 rounded-2xl z-20 max-w-xs emerald-glow">
              ...
              <p className="text-sm text-[var(--text-secondary)]">Reducing pesticide use by up to 40% through precision detection.</p>
            </div>
          </motion.div>

          <motion.div {...fadeUp} transition={{ ...fadeUp.transition, delay: 0.2 }}>
            <h2 className="text-3xl lg:text-5xl font-bold text-[var(--text-primary)] mb-8 leading-tight">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[var(--text-primary)] mb-1">Ecological Restoration</h4>
                  <p className="text-sm text-[var(--text-secondary)]">Targeted treatments that protect local biodiversity and soil microbes.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                <div className="mt-1 text-primary-500">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[var(--text-primary)] mb-1">Data Sovereignty</h4>
                  <p className="text-sm text-[var(--text-secondary)]">Empowering individual land owners with enterprise-grade analytic tools.</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 relative">
        <motion.div {...fadeUp} className="text-center mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold text-[var(--text-primary)]">Our Journey</h2>
          ...
          {timeline.map((item, i) => (
            ...
            >
              <div className={`md:w-[45%] ${item.side === 'left' ? 'md:text-right' : ''}`}>
                ...
                <h3 className="text-xl font-bold text-[var(--text-primary)] mt-1 group-hover:text-primary-500 transition-colors">
                  {item.title}
                </h3>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <motion.div {...fadeUp} className="mb-16">
          <h2 className="text-3xl lg:text-5xl font-bold text-[var(--text-primary)] mb-4">Innovation Team</h2>
          <p className="text-[var(--text-secondary)] max-w-xl">Meet the world-class researchers and engineers dedicated to the future of precision agriculture.</p>
        </motion.div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {team.map((member, i) => (
            ...
            >
              <div className="aspect-[3/4] bg-eo-surface-container-high flex items-center justify-center group-hover:bg-eo-surface-container-highest transition-colors">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-eo-bg to-transparent pt-20">
                <h4 className="text-lg font-bold text-[var(--text-primary)]">{member.name}</h4>
      ...
      <section className="max-w-7xl mx-auto px-6 py-24">
        <motion.div {...fadeUp} className="relative glass-card rounded-[2.5rem] p-12 md:p-24 overflow-hidden text-center emerald-glow">
          ...
          <h2 className="text-3xl lg:text-5xl font-bold text-[var(--text-primary)] mb-8 max-w-2xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <button className="w-full sm:w-auto border border-eo-outline-variant text-[var(--text-primary)] px-10 py-4 rounded-full font-bold hover:bg-eo-surface-container-high transition-all cursor-pointer">
              Contact HR
            </button>
          </div>
        </motion.div>
