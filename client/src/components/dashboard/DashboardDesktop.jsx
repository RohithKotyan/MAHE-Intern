...
export default function DashboardDesktop() {
  return (
    <div className="flex h-full w-full">
      {/* SideNavBar */}
      <nav className="fixed left-0 top-0 h-full w-[280px] bg-surface-container-low dark:bg-surface-container-low/90 backdrop-blur-lg border-r border-outline-variant/20 shadow-2xl flex flex-col py-base z-40 hidden md:flex">
        ...
        <div className="flex-1 overflow-y-auto px-4 space-y-2">
          <a className="bg-secondary-container/20 text-secondary border-r-4 border-secondary px-4 py-3 flex items-center gap-3 rounded-lg transition-all duration-300 ease-in-out" href="#">
            <span className="material-symbols-outlined">dashboard</span>
            Dashboard
          </a>
          <a className="text-on-surface-variant px-4 py-3 flex items-center gap-3 rounded-lg hover:bg-surface-variant/50 hover:text-on-surface transition-all duration-300 ease-in-out" href="#">
            <span className="material-symbols-outlined">groups</span>
            Community
          </a>
          <a className="text-on-surface-variant px-4 py-3 flex items-center gap-3 rounded-lg hover:bg-surface-variant/50 hover:text-on-surface transition-all duration-300 ease-in-out" href="/dashboard/crops">
      ...
      <main className="flex-1 ml-[280px] h-full overflow-y-auto bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] relative bg-surface">
        ...
        {/* Content Canvas */}
        <div className="pt-24 pb-12 px-container-margin max-w-7xl mx-auto space-y-6 flex flex-col gap-gutter md:gap-container-margin">
          {/* Page Header */}
