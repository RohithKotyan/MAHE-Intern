      ...
      <div className="flex-1 glass-panel rounded-2xl p-6 relative min-h-[400px]">
        {activeMenu === 'account' && (
          <div className="animate-in fade-in duration-300">
            <h2 className="font-body-md text-xl font-bold text-on-surface mb-6 border-b border-outline-variant/20 pb-4">Account Profile</h2>
            
            <div className="space-y-6 max-w-2xl">
              <div className="flex items-center gap-6">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuAF534OOD6MQtE1HdOyBiNkKycRZA0RzZNRRjIZ89YH-Wdh5XAWoyOIuPclMb87uWpT40cd-zm90r-BMMPHlVpidBTddGR9y5aRv5le0pxg0UXBypn_BjvOS5D2KC7OK1U-wL-2h_Dc0HhXpbCNyYkDg9UO4m54pZpfMt8M3V8RFv0PCfh3yRlCFCybiblJhU14fMYB7A7-mwE5PLmTRYzylceFwTAn-3mEuhlGJwSiaw6tRxEYFla544qe8o7EcCWd99T8daL5NQ" alt="Avatar" className="w-20 h-20 rounded-full object-cover border-2 border-outline-variant/30" />
                <div>
                  <button className="px-4 py-2 bg-surface-container-high hover:bg-surface-variant text-on-surface text-sm font-semibold rounded-lg transition-colors border border-outline-variant/30 mb-2">Change Avatar</button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" defaultValue="Rohith Kotyan" className="w-full bg-surface-container/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all" />
                </div>
                <div>
                  <label className="block font-label-sm text-[11px] text-on-surface-variant mb-1 ml-1 uppercase tracking-wider">Location</label>
                  <input type="text" defaultValue="Udupi, Karnataka" className="w-full bg-surface-container/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all" />
                </div>
                <div className="md:col-span-2">
                  ...
                  <textarea defaultValue="Growing smarter with AI farming." rows="3" className="w-full bg-surface-container/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all resize-none"></textarea>
                </div>
                <div>
                  <label className="block font-label-sm text-[11px] text-on-surface-variant mb-1 ml-1 uppercase tracking-wider">Farming Scale</label>
                  <select className="w-full bg-surface-container/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all appearance-none">
                    <option>Small Scale (1-5 Acres)</option>
                    <option>Medium Scale (5-20 Acres)</option>
                    <option>Large Scale (20+ Acres)</option>
                    <option>Greenhouse / Polyhouse</option>
                  </select>
                </div>
                <div>
                  <label className="block font-label-sm text-[11px] text-on-surface-variant mb-1 ml-1 uppercase tracking-wider">Primary Crops</label>
                  <input type="text" defaultValue="Tomato, Chilli, Bell Pepper" className="w-full bg-surface-container/50 border border-outline-variant/30 rounded-xl px-4 py-3 text-sm text-on-surface focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/30 transition-all" />
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-outline-variant/20 flex justify-end gap-3">
                ...
                <button className="px-5 py-2 bg-primary text-on-primary-fixed hover:scale-[1.02] rounded-xl font-bold text-sm shadow-md transition-all">Save Changes</button>
              </div>
